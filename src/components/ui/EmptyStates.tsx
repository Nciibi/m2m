...
export function NoChatsIllustration() {
  return (
    <div className="empty-illustration empty-illustration--sm">
      {/* Background soft glow */}
      <div className="empty-illustration__glow"></div>

      {/* Grid Pattern */}
      <svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="empty-illustration__svg empty-illustration__svg--grid">
        <defs>
      ...
      <svg width="140" height="140" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="empty-illustration__svg--front">
        {/* Connection line */}
        <path d="M40 70 H100" stroke="var(--color-accent)" strokeWidth="1.5" strokeDasharray="3 3" className="empty-illustration__dash" />

        {/* Left Bubble */}
        <g className="empty-illustration__bounce">
        ...
        {/* Right Bubble */}
        <g className="empty-illustration__bounce" style={{ animationDelay: "1s" }}>
        ...
        <g className="empty-illustration__bounce--fast" style={{ animationDelay: "0.5s" }}>
...
export function RadarIllustration() {
  return (
    <div className="empty-illustration empty-illustration--lg">
      {/* Background Soft Glow */}
      <div className="empty-illustration__glow"></div>

      <svg width="220" height="220" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="empty-illustration__svg">
        {/* Outer dotted ring */}
        ...
        <circle cx="110" cy="110" r="12" stroke="var(--color-accent)" strokeWidth="1.5" className="empty-illustration__ping" style={{ transformOrigin: "110px 110px" }} />
        ...
        <line
          ...
          strokeWidth="1.5"
          className="empty-illustration__sweep"
        />

        {/* Pulsing Target Node 1 */}
        <g className="empty-illustration__target">
        ...
        <g className="empty-illustration__target--slow" style={{ animationDelay: "1s" }}>
  ...
  return (
    <div className="empty-illustration empty-illustration--sm">
      ...
      <svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="empty-illustration__bounce--slow">
        ...
        <g className="empty-illustration__bounce--slow" style={{ animationDelay: "0.8s" }}>
        ...
        <g className="empty-illustration__bounce--slow" style={{ animationDelay: "1.6s" }}>
        ...
        <g className="empty-illustration__pulse">
