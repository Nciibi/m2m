...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_stun_config,
            commands::set_stun_servers,
            commands::set_private_mode,
            commands::check_connectivity,
            commands::get_network_diagnostics,
            commands::get_network_settings,
            commands::set_tor_enabled,
            commands::list_manual_forwards,
            commands::add_manual_forward,
            commands::remove_manual_forward,
            commands::reorder_manual_forwards,
